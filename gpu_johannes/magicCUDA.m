...
commandstr = ['nvcc -O3 -DNDEBUG -c ' newstring ' -arch sm_13 -lcula_lapack -lcublas -Xcompiler -fPIC -I$CULA_INC_PATH -I/usr/local/lehrstuhl/DIR/matlab-R2015a/extern/include -I/usr/local/lehrstuhl/DIR/matlab-R2015a/toolbox/distcomp/gpu/extern/include']
unix(commandstr)
