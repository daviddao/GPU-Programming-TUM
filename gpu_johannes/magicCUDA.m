...
commandstr = ['nvcc -O3 -DNDEBUG -c ' newstring ' --gpu-architecture=compute_20 --gpu-code=sm_20,compute_20 -lcula_lapack -lcublas -Xcompiler -fPIC -I$CULA_INC_PATH -I/usr/local/lehrstuhl/DIR/matlab-R2015a/extern/include -I/usr/local/lehrstuhl/DIR/matlab-R2015a/toolbox/distcomp/gpu/extern/include']
unix(commandstr)
