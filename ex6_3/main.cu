...
__global__ void convolutionkernel(float *d_imgIn, float *d_imgOut, int w, int h, int nc, int radius)
{
...
//			cudaMemcpyHostToDevice);
	...
	convolutionkernel <<<grid,block>>> (d_imgIn, d_imgOut, w, h, nc, radius);
